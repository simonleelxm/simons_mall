package com.simon.cmall.cart.controller;
...
public class CartController {
    ...
    @LoginRequired(loginSuccess = false)
    public String addToCart(String skuId, int quantity, HttpServletRequest request, HttpServletResponse response, HttpSession session,RedirectAttributes redirectAttributes) {
        List<OmsCartItem> omsCartItems = new ArrayList<>();
        ...
        if (StringUtils.isBlank(memberId)) {
            ...
            // 用户已经登录
            // 从db中查出购物车数据
//            List<OmsCartItem> omsCartItems1 = cartService.cartList(memberId);
