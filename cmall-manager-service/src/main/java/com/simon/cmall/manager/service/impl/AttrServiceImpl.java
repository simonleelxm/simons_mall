...
import com.simon.cmall.manager.mapper.PmsBaseAttrInfoMapper;
import com.simon.cmall.manager.mapper.PmsBaseAttrValueMapper;
import com.simon.cmall.manager.mapper.PmsBaseSaleAttrMapper;
...
//            List<PmsBaseAttrValue> pmsBaseAttrValues = new ArrayList<>()
    ...
    public String saveAttrInfo(PmsBaseAttrInfo pmsBaseAttrInfo) {
        ...
        if (StringUtils.isBlank(id)){
            ...
            //attr_value删除对应attr_info
            PmsBaseAttrValue pmsBaseAttrValuesDel =  new PmsBaseAttrValue();
            pmsBaseAttrValuesDel.setAttrId(pmsBaseAttrInfo.getId());
            pmsBaseAttrValueMapper.delete(pmsBaseAttrValuesDel);
